...
def match(test_img, RANGE, THRES0, THRES1, T2):
    ...
    test_img = '/home/wangya/wine/distributed_4/data/files_4/test/'+test_image_name+'.jpg'
    im = cv2.imread(test_img)
  
    mask_file = '/home/wangya/wine/distributed_4/data/files_4/test_mask/'+test_image_name+'.jpg'
    ...
    croped_dir = '/home/wangya/wine/distributed_4/data/files_4/test_crop/'+test_image_name+'.jpg'
   ...
   # test_img = './1.jpg'
    ...
    for img in os.listdir(dir):
        ...
        for result_img in result_imgs:
            ...
            read_result.cp_img(test_img,result_img,'/home/wangya/wine/distributed_4/data/model/part4/cnn_sift/result_5brand_5')
    print('total time is :',t)   
    print('avg time is :',t/9193)
