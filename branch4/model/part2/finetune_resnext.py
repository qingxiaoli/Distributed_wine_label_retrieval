...
def get_iterators(batch_size, data_shape=(3, 192, 128)):
    train = mx.io.ImageRecordIter(
        path_imgrec         = '/home/wangya/wine/distributed_4/data/files_2/train.rec',
        data_name           = 'data',
    ...
    val = mx.io.ImageRecordIter(
        path_imgrec         = '/home/wangya/wine/distributed_4/data/files_2/test.rec',
        data_name           = 'data',
        label_name          = 'softmax_label',
        batch_size          = batch_size,
        data_shape          = data_shape,
...
sym, arg_params, aux_params = mx.model.load_checkpoint('/home/wangya/wine/distributed_2/1/model/myresnext_wd0.00008', 20)
...
model_prefix = './myresnext_wd0.00008'
def fit(symbol, arg_params, aux_params, train, val, batch_size, num_gpus):
    ...
    mod.fit(train, val,
        ...
        kvstore='device',
        optimizer='sgd',
        optimizer_params={'learning_rate':0.01,'wd':0.00008},
        initializer=mx.init.Xavier(rnd_type='gaussian', factor_type="in", magnitude=2),
        eval_metric='acc',
        begin_epoch=20)
    mod.save(model_prefix)
