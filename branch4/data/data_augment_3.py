...
if __name__ == '__main__':
    ...
    train_label_file = '/home/wangya/wine/distributed_4/data/files_3/train.xlsx'
    train_files = '/home/wangya/wine/distributed_4/data/files_3/train/'
    aug_files = '/home/wangya/wine/distributed_4/data/files_3/aug_train/'
    ...
    rx1= max_num
    y1 = rx1 * 10.0 #y1 =max brand has max data after aug
    rx2 = min_num
    y2 = y1  #  y1 =min brand has min data after aug
    x1 = np.log(rx1)
    x2 = np.log(rx2)
    a = (y1 - y2) / (x1 - x2)
    b = (x1 * y2 - x2 * y1) / (x1 - x2)
    ...
    print(len(train_num_data_primary))
