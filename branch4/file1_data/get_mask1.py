...
pallete = [ 0,0,0,
            255,255,255 ]
model_previx = "/home/wangya/wine/distributed_2/data/code/seg/model_pascal/FCN8s_VGG16"
epoch = 2
ctx = mx.gpu(0)
...
def do(x,n):
    ...
    files_dir = '/home/wangya/wine/distributed_4/data/files_1/aug_train'
    num = x
    for file in os.listdir(files_dir)[x:n]:
        ...
        out_img.save('/home/wangya/wine/distributed_4/data/files_1/aug_train_mask/%s'%save_name)
