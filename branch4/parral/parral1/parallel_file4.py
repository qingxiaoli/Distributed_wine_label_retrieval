...
with open('/home/wangya/wine/distributed_4/data/files_1/app_train_sifts.pkl', 'rb') as point:
...
# app_train_sifts = load_sift()
with open('/home/wangya/wine/distributed_4/data/files_2/app_train_sifts.pkl', 'rb') as point:
...
# app_train_sifts = load_sift()
with open('/home/wangya/wine/distributed_4/data/files_3/app_train_sifts.pkl', 'rb') as point:
...
# app_train_sifts = load_sift()
with open('/home/wangya/wine/distributed_4/data/files_4/app_train_sifts.pkl', 'rb') as point:
...
def match(job_num, test_img, RANGE, THRES0, THRES1, T2):
    ...
    if job_num == 0:
    	...
    	app_train_sifts, app_train_names, brand, app_brand_dic, model = app_train_sifts3, app_train_names3, brand3, app_brand_dic3, model3
    elif job_num == 3:
    	app_train_sifts, app_train_names, brand, app_brand_dic, model = app_train_sifts4, app_train_names4, brand4, app_brand_dic4, model4
    else:
...
def cnn_sift(test_img):
    ...
    result_imgs3,_ = match(2, test_img, RANGE, THRES0, THRES1, T2)
	result_imgs4,_ = match(3, test_img, RANGE, THRES0, THRES1, T2)


	for result_img in result_imgs1:
	    result_img = result_img + '.jpg'
	    result_img = os.path.join('/home/wangya/wine/distributed_4/data/files_1/train', result_img)
	    read_result.cp_img(test_img,result_img,'/home/wangya/wine/distributed_4/parallel/result_5brand_5')

	for result_img in result_imgs2:
	    result_img = result_img + '.jpg'
	    result_img = os.path.join('/home/wangya/wine/distributed_4/data/files_2/train', result_img)
	    read_result.cp_img(test_img,result_img,'/home/wangya/wine/distributed_4/parallel/result_5brand_5')

    for result_img in result_imgs3:
	    result_img = result_img + '.jpg'
	    result_img = os.path.join('/home/wangya/wine/distributed_4/data/files_3/train', result_img)
	    read_result.cp_img(test_img,result_img,'/home/wangya/wine/distributed_4/parallel/result_5brand_5')

	for result_img in result_imgs4:
	    result_img = result_img + '.jpg'
	    result_img = os.path.join('/home/wangya/wine/distributed_4/data/files_4/train', result_img)
	    read_result.cp_img(test_img,result_img,'/home/wangya/wine/distributed_4/parallel/result_5brand_5')

if __name__ == '__main__':
    dir = '/home/wangya/wine/distributed_4/data/files_4/test'
    start = time.time()
