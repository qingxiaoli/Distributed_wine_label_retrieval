...
def SIFT(test_img,RANGE, THRES0, THRES1, T2):
    ...
    app_train_names_sub = np.hstack((app_train_names_sub1, app_train_names_sub2))
    for i in best:
   ...
   # test_img = './1.jpg'
    ...
    for img in os.listdir(dir):
        ...
        for result_img in result_imgs:
            ...
            result_img1 = os.path.join('/home/wangya/wine/distributed/data/files_1/train',result_img)
            result_img2 = os.path.join('/home/wangya/wine/distributed/data/files_2/train',result_img)
            if os.path.exists(result_img1):
                read_result.cp_img(test_img,result_img1,'/home/wangya/wine/distributed/parallel/result_5brand_5_fa2')
            else:
                read_result.cp_img(test_img,result_img2,'/home/wangya/wine/distributed/parallel/result_5brand_5_fa2')
    ...
    print('avg time is :',ti/21170)
    
    print('total time is :',t)   
    print('avg time is :',t/78909)
