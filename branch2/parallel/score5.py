...
train1_xlxs = '/home/wangya/wine/distributed/data/files_1/train.xlsx'
test1_xlxs = '/home/wangya/wine/distributed/data/files_1/test.xlsx'
train2_xlxs = '/home/wangya/wine/distributed/data/files_2/train.xlsx'
test2_xlxs = '/home/wangya/wine/distributed/data/files_2/test.xlsx'
...
train_cont = train_cont1 + train_cont2
print(len(train_cont))
train_dic = creat_dic(train_cont)
test_cont = test_cont1 + test_cont2
print(len(test_cont))
test_dic = creat_dic(test_cont)
tests_id = [t[0] for t in test_cont] 
results_dir = '/home/wangya/wine/distributed/parallel/result_5brand_5'
