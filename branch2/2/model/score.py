...
def score(data_val, metrics, gpus, batch_size, rgb_mean=None, mean_img=None,
          image_shape='3,192,128', data_nthreads=4, label_name='softmax_label', max_num_examples=None):
    ...
    sym,arg_params,aux_params = mx.model.load_checkpoint('/home/wangya/wine/distributed/2/model/myresnext_wd0.00008',5)
    # create module
    if gpus == '':
        devs = mx.cpu()
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-shape', type=str, default='3,192,128')
