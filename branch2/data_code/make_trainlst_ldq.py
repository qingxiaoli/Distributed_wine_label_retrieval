...
with open('/home/wangya/wine/distributed/data/files_2/train.xlsx') as f:
...
with open('/home/wangya/wine/distributed/data/files_2/train_label_index.pkl', 'wb') as output:
    pickle.dump(bd, output) 

with open('/home/wangya/wine/distributed/data/files_2/train_dic.pkl', 'rb') as point:
    image_inf = pickle.load(point)

to_write = []
idx = 0
for image in os.listdir('/home/wangya/wine/distributed/data/files_2/aug_data_crop/'):
    im_id = image.split('_')[0]
    to_write.append('%d\t%d\t/home/wangya/wine/distributed/data/files_2/aug_data_crop/%s\n'%(idx, bd[image_inf[im_id][0]],image))
    idx += 1
...
with open('/home/wangya/wine/distributed/data/files_2/train.lst', 'w') as f:
