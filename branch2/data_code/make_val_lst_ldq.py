...
with open('/home/wangya/wine/distributed_4/data/files_1/train_label_index.pkl', 'rb') as pkl_file:
	data1 = pickle.load(pkl_file)

with open('/home/wangya/wine/distributed_4/data/files_1/test_dic.pkl', 'rb') as point:
    image_inf = pickle.load(point)

to_write = []
idx = 0
for image in os.listdir('/home/wangya/wine/distributed_4/data/files_1/test/'):
    im_id = image.split('.')[0]
    to_write.append('%d\t%d\t/home/wangya/wine/distributed_4/data/files_1/test/%s\n'%(idx, data1[image_inf[im_id][0]],image))
    idx += 1

print(idx) #this is the all num of data in the train subset
random.shuffle(to_write) # make random for traindata

with open('/home/wangya/wine/distributed/data/files_2/test.lst', 'w') as f:
