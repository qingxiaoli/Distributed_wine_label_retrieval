...
sym, arg_params, aux_params = mx.model.load_checkpoint('/home/wangya/wine/distributed/1/model/myresnext0001', 5)
...
def fit(symbol, arg_params, aux_params, train, val, batch_size, num_gpus):
    ...
    mod.fit(train, val,
        ...
        kvstore='device',
        optimizer='sgd',
        optimizer_params={'learning_rate':0.01,'wd':0.001},
