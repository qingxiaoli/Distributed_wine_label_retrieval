...
sym, arg_params, aux_params = mx.model.load_checkpoint('/home/wangya/wine/distributed/1/model/myresnext_wd0.00015', 5)
...
model_prefix = './myresnext_wd0.00015'
def fit(symbol, arg_params, aux_params, train, val, batch_size, num_gpus):
    ...
    mod.fit(train, val,
        ...
        kvstore='device',
        optimizer='sgd',
        optimizer_params={'learning_rate':0.01,'wd':0.00015},
