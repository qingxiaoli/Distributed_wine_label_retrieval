...
def match(test_img, RANGE, THRES0, THRES1, T2):
    ...
    test_img = '/home/wangya/wine/distributed/data/files_1/test/'+test_image_name+'.jpg'
    im = cv2.imread(test_img)
  
    mask_file = '/home/wangya/wine/distributed/data/files_1/test_mask/'+test_image_name+'.jpg'
    ...
    croped_dir = '/home/wangya/wine/distributed/data/files_1/test_crop/'+test_image_name+'.jpg'
    ...
    result_imgs = []
    for brandd in brand:
    	candi = app_train_sifts[app_brand_dic[brandd]]
        n_candi = len(candi)
        ...
        best = np.argsort(npscore)[-1]
        result_img = app_train_names[app_brand_dic[brandd]][best]
   ...
   # test_img = './1.jpg'
    ...
    for img in os.listdir(dir):
        ...
        for result_img in result_imgs:
            ...
            read_result.cp_img(test_img,result_img,'/home/wangya/wine/distributed/1/result_5brand_51')
    print('total time is :',t)   
    print('avg time is :',t/21170)
